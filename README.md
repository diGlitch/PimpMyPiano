...
* software that runs on the Nucleo. The source code is published in the [MBed Git](https://os.mbed.com/users/diglitch/code/PimpMyPiano/) as well as exports for different toolchains in the src folder.
